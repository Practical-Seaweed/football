...
// this function will display the details about out football team
function displayFootballTeam(){
    ...
    resultsParagraph.innerHTML = `You selected the ${selectedTeam.name} (${selectedTeam.code}) who plays in ${selectedTeam.plays}`
